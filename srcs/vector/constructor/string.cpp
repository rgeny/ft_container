...
/*   Updated: 2022/05/17 17:40:05 by rgeny            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main	(void)
{
	_print_nl("dfl ctor : ");
	{
		...
		_print_size(v);
		for_each(v.begin(), v.end(), _print_val<std::string>);
	}
	...
	_print_nl("fill ctor : ");
	{
		...
		_print_val_and_size<NAMESPACE::vector<std::string>, std::string>(v);
	}
	...
	_print_nl("range ctor : ");
	{
		...
		_print_val_and_size<NAMESPACE::vector<std::string>, std::string>(v2);
	}
